...
class AgentTeamMail < Formula
  ...
  on_macos do
    on_intel do
      url "https://github.com/randlee/atm-core/releases/download/v1.0.0/atm-x86_64-apple-darwin.tar.gz"
    ...
    on_arm do
      url "https://github.com/randlee/atm-core/releases/download/v1.0.0/atm-aarch64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_intel do
      if Hardware::CPU.is_64_bit?
        url "https://github.com/randlee/atm-core/releases/download/v1.0.0/atm-x86_64-unknown-linux-gnu.tar.gz"
